    ...
    <section class="mx-auto max-w-5xl px-6 pt-12 items-center" style={{ minHeight: 'calc(100vh - 64px)' }}>
      ...
      <div>
        <h1 class="font-bold text-white text-4xl sm:text-5xl md:text-6xl">
          <span class="text-luminescent-400" style={{ filter: 'drop-shadow(0 0 2rem #CB6CE6);' }}>Privacy</span> Policy / <span class="text-luminescent-400" style={{ filter: 'drop-shadow(0 0 2rem #CB6CE6);' }}>Terms</span> of Use.
        </h1>
      ...
      <div class="mt-5 text-lg text-gray-500">
        <p class="text-2xl">By using Lumins's services in any form you agree to the following privacy policy / terms of use and the storage of necessary functional data.</p>
        <br />
        <ol class="list-decimal list-inside">
          ...
          <li>
            ...
            <ol class="list-disc list-inside">
              ...
              <li>User Id if the user has been punished by Lumin, it gets deleted when the punishment ends</li>
              <li>All information set in the <a href="/dashboard" class="underline">dashboard</a> will be deleted if Lumin gets removed from the associated server</li>
            </ol>
          </li>
          <br />
          <li>
