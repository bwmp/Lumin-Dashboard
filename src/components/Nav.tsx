...
// @ts-ignore
import iconAVIF from '~/components/images/Lumin.png?format=avif&w=96&h=96';
// @ts-ignore
import iconWEBP from '~/components/images/Lumin.png?format=webp&w=96&h=96';
// @ts-ignore
import icon from '~/components/images/Lumin.png?w=96&h=96';
  ...
  return (
    <div class="flex items-center justify-start">
      <Link href="/" class="transition ease-in-out text-gray-300 hover:bg-gray-800 hover:text-white drop-shadow-2xl pl-3 pr-3 md:pr-4 py-3 rounded-lg text-lg flex gap-2 items-center whitespace-nowrap">
        ...
        <span class="hidden md:flex">Lumin</span>
